...
$(document).ready(function() {
	...
	$("#search").click(function() {
		...
		//주제별 자료검색
		$('#ab1').click(function(){
			location.href="BookSearch/search.bo";
		});
	/* 	//희망도서검색
		$('#ab2').click(function(){
			location.href="#";
	...
	$("#a1").click(function() {
		...
		//공지사항
		$('#no1').click(function(){
			location.href="LibraryInfo/notice.bo";
		});
		//자주하는질문
		$('#no2').click(function(){
			location.href="LibraryInfo/qnA.bo";
		});
		//좌석예약
		$('#no3').click(function(){
			location.href="StudyRoom/studyRoom.bo";
		});
	});
	$(".c1").hide(); //하단
	$("#bb1").click(function() {
	...
	$("#bb2").click(function() {
		...
		$('#Guide2').click(function(){
			location.href="LibraryInfo/closeDay.bo";
		});
		//회원가입안내
		$('#Guide3').click(function(){
			location.href="LibraryInfo/joinGide.bo";
		});
		//시설이용안내
		$('#Guide4').click(function(){
			location.href="LibraryInfo/road.bo";
			});
	/* 	//자료이용안내
		...
		$('#Guide6').click(function(){
			location.href="LibraryInfo/roadFind.bo";	
		});
...
<body class="subpage">
	...
	<nav id="menu">
		<ul class="links">
			...
			<div class="subMenu">
				<ul>
					<li class="search1" id= "s1"><a href="#" class="w3-button btn" id="ab1">주제별 자료검색</a></li>
					<li class="search1"><a href="#" class="w3-button btn" id="bba1" id="ab2">희망도서신청</a></li>
			...
			<ul>
				...
				<li class="b3"><a href="#" class="w3-button btn">대출예약 확인 및 취소</a></li>
