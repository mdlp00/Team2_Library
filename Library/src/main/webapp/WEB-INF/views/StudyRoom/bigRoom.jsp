...
<div class="w3-content" style="max-width:1100px; margin-top: 10px;">
	...
	<div class="w3-row" style="height: 500px;">
		<img class="w3-img" src="resources/img/studyL_1.jpg" style="height: 100%; width: 100%;">
	</div>
	<!-- 소제목 -->
	<div class="w3-row w3-center" style="margin: 20px 0px 70px;">
		<div style="display: inline-block; width: 500px;">
			<h1 style="margin-bottom: 10px;">D.L. the Big Room</h1>
			<p style="color: gray;">8명 ~ 12명 정도의 사람들이 자유롭게 사용할 수 있는 공간</p>
		</div>
	</div>
	<!-- 스터디룸 소개 -->
	<div class="w3-row" id="about">
		...
		<div class="w3-col m9" style="height: 600px;">
			<div class="ttl">
				<div>
					<img class="w3-img read" src="resources/img/studyL_2.jpg">
				</div>
				<div class="SSul">
					<h1 class="w3-xxlarge ssul"><b>the Big Room<br>큰 방</b></h1>
					<div style="background-color: #f6755e; width: 20px; height: 4px; margin-bottom: 15px;"></div>
					<p class="ssul ftnbg" style="color: black;">이 곳은 Daye Library가 제공하는 도전과 혁신의 공간<br> <strong>큰 방</strong> 입니다.</p>
					<div style="height: 20px;"><p></p></div>
					<p>공간 내 무료로 제공되는 coffee, tea가 있습니다.<br>여러가지 회의와 작업을 하기에 충분한 공간입니다.</p>
			...
			<div class="w3-content w3-padding cal_ttl">
				<div class="w3-row ftnbg">
					...
					<ul style="margin: 0px 0px 10px 0px; padding: 0px; list-style: none;">
						...
						<li class="li_border"><span style="margin: 5px 15px 5px 5px;">예약 인원 :</span><span>최소 2명 ~ 최대 4명</span></li>
					</ul>
					<div class="li_border">
