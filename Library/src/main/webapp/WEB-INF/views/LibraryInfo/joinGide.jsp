...
<div class="content">
	<div class="doc">
		<div class="doc-head">
			<div class="doc-title">
				<h3 style="font-size: 40px; max-width: 500px; padding: 20px;">회원가입안내</h3>
			</div>
		</div>
	</div>
</div>
<div class="doc-body" id="contentArea">
	<div class="body">
			...
			<ul class="con" style="margin-top:30px;">
				<li>
					<strong class="contener"> 가입자격</strong>
				</li>
					<ul>
						<li>
						"주민등록상 서울특별시 거주자"
				...
				<li>
					...
					<ul>
						<li>
							홈페이지 신규 회원가입->도서관 방문->본인 확인(서류지참)->회원증발급
						</li>
					</ul>
				</li>
				<li>
				...
				<li>
					<strong>22개 서울특별시교육청 공공도서관 평생학습관 회원증 소지자는 즉시 이용가능</strong>
				</li>
				<li>
