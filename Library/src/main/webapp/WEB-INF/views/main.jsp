...
<body>
   ...
   <!-- Banner -->
   <section id="banner" style="background-image:url('img/MainP.jpg');">
   ...
   <section id="one" class="wrapper">
      <div class="inner flex flex-3">
         ...
         <div class="flex-item image fit round">
            <img src="resources/img/library_0.jpg" alt="" />
         </div>
   ...
   <section id="three" class="wrapper">
      <div class="inner flex flex-3">
         ...
         <div class="flex-item box">
            <div class="image fit">
               <img src="resources/img/readingRoom_2.jpg" alt="" />
            </div>
            <div class="content">
               <h3>Adipiscing</h3>
         ...
         <div class="flex-item box">
            <div class="image fit">
               <img src="resources/img/library_3.jpg" alt="" />
            </div>
            <div class="content">
               <h3>Malesuada</h3>
